    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('Registered', 'Registered - Should authenticate phone'), ('Phone complete', 'Phone complete -  Should enter profile'), ('Profile complete', 'Profile complete - Should authenticate school'), ('School complete', 'School complete - School authentication complete')], default='Registered', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.ForeignKey(db_column='college', on_delete=django.db.models.deletion.CASCADE, related_name='colleges', to='accounts.college')),
                ('university', models.ForeignKey(db_column='university', on_delete=django.db.models.deletion.CASCADE, related_name='universities', to='accounts.university')),
            ],
            options={
                'db_table': 'major',
            },
        ...
        migrations.AddField(
            model_name='college',
            name='university',
            field=models.ForeignKey(db_column='university', on_delete=django.db.models.deletion.CASCADE, to='accounts.university'),
        ),
        migrations.AddField(
            model_name='user',
            name='college',
